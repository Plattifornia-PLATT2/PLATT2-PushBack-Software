#ifndef PURPLE_PUMPNDUMP_HPP
#define PURPLE_PUMPNDUMP_HPP
...
/**
 * @brief The purple robot competition autonomous routine implementation
...
class PurplePumpnDumpAuton : public auton::IAuton {
    ...
    const std::string AUTON_NAME {"Purple_Comp_PumpnDump"};
