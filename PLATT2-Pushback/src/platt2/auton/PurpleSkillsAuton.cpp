...
void PurpleSkillsAuton::run() {
    ...
    holonomic_subsytem->moveToPoint(116, 12.75, 90, 0.5, 0.4, 3);
    pros::delay(1500);
    ...
    //Far Matchloader
    intake_subsystem->toggle_rear_intake_piston();
    holonomic_subsytem->moveToPoint(118.5, 128.5, 270, 0.5, 0.4, 2);
    pros::delay(2500);

    //Far Long Goal Second Score
    holonomic_subsytem->moveToPoint(119.15, 99, 270, 0.6, 0.2, 3);
    intake_subsystem->toggle_rear_intake_piston();
    intake_subsystem->toggle_conveyor_stopper_piston();
    pros::delay(1500);
    intake_subsystem->move_intake(robot::subsystems::intake::IN);
    ...
    pros::delay(500);
    holonomic_subsytem->moveToPoint(72,109, 270, 0.5, 0.4, 2);
    holonomic_subsytem->moveToPoint(72,113, 270, 0.5, 0.4, 2);
    pros::delay(1500);
    intake_subsystem->toggle_rear_intake_piston();
    pros::delay(1000);
    intake_subsystem->toggle_rear_intake_piston();
    ...
    //Red Blocks on Wall
    holonomic_subsytem->moveToPoint(134.5, 115, 0, 0.8, 0.4, 3);
    intake_subsystem->toggle_rake_mech_piston();
    pros::delay(750);

    //Red Block in Middle by Long Goal
    holonomic_subsytem->moveToPoint(101, 113, 180);
    holonomic_subsytem->moveToPoint(94, 70, 270);
    intake_subsystem->move_intake(robot::subsystems::intake::STOP);
