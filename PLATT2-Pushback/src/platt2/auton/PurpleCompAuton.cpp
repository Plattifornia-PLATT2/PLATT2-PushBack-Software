...
void PurpleCompAuton::run() {
    ...
    holonomic_subsytem->moveToPoint(119.5, 20, 275);
    intake_subsystem->move_intake(robot::subsystems::intake::IN);
    holonomic_subsytem->moveToPoint(119.5, 8.25, 275, 0.2, 0.3, 3);
    intake_subsystem->move_intake(robot::subsystems::intake::OUT);
    pros::delay(200);
    intake_subsystem->move_intake(robot::subsystems::intake::IN);
    pros::delay(2000);
    //intake_subsystem->move_intake(robot::subsystems::intake::STOP);
    holonomic_subsytem->moveToPoint(119.5, 12, 270, 0.15, 0.15, 3);
    holonomic_subsytem->moveToPoint(120,39.5, 90, 0.3, 0.15, 3);
    pros::delay(200);
    intake_subsystem->move_intake(robot::subsystems::intake::IN);
    ...
    intake_subsystem->toggle_conveyor_stopper_piston();
    intake_subsystem->move_intake(robot::subsystems::intake::STOP);
    holonomic_subsytem->moveToPoint(119.5, 8.25, 275, 0.3, 0.3, 5);
    intake_subsystem->move_intake(robot::subsystems::intake::IN);
    pros::delay(2500);
    holonomic_subsytem->moveToPoint(119.5, 12, 270, 0.15, 0.15, 3);
    holonomic_subsytem->moveToPoint(120,39.5, 90, 0.3, 0.15, 3);
    ...
    intake_subsystem->toggle_conveyor_stopper_piston();
    intake_subsystem->move_intake(robot::subsystems::intake::STOP);
    holonomic_subsytem->moveToPoint(119.5, 8, 275, 0.3, 0.3, 5);
    intake_subsystem->move_intake(robot::subsystems::intake::IN);
    pros::delay(2000);
