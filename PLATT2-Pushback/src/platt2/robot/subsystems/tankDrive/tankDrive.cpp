...
namespace subsystems{
    ...
    void tankDrive::moveVector(MovementVector v){ 
        ...
        drive_modules[0]->module_motors.setVoltage(v.r+v.w);
        drive_modules[1]->module_motors.setVoltage(v.r-v.w);
       
    }

    tankModule::tankModule(std::unique_ptr<pros::Motor>& motor_1, std::unique_ptr<pros::Motor>& motor_2, std::unique_ptr<pros::Motor>& motor_3, std::unique_ptr<pros::Motor>& motor_4){
