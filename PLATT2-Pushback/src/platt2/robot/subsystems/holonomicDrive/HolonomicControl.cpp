...
HolonomicControl::HolonomicControl(std::unique_ptr<XDrive> drive, std::unique_ptr<odometry::Odometry> odom, std::unique_ptr<robot::pid::PID> posPID, std::unique_ptr<robot::pid::PID> headingPID):
    drivetrain(std::move(drive)),
